...
// Initialize Timber's JS on docready
    ...
    theme.Header = (function() {
        ...
        function menuStyleCheck() {
            if (cache.$siteHeader.hasClass('site-header--classic')) {
                ...
                timber.cache.$window.on('load', function() {
                    ...
                    timber.cache.$navBar.attr('aria-hidden', 'false');
                    fitNav();
                    timber.cache.$window.on('resize', $.debounce(100, fitNav));
        ...
        function stickyHeader () {
            ...
            if (cache.$siteHeader.hasClass('site-header--classic')) {
                ...
                // Sub nav stuff
                var $navItems = cache.$siteHeaderSticky.find('.js-nav-item');
                $navItems.hover(function() {
                    var itemIndex = $(this).data('nav-item');
                    $('.js-sub-nav[data-nav-item="' + itemIndex + '"').toggleClass('is-visible');
                });
    ...
    theme.Slideshow = (function(el) {
        ...
        this.cache = {
            ...
            sliderArgs: {
                ...
                controlNav: true,
                keyboard: true,
                prevText: "<div class='c-slider__icon-wrapper c-slider__icon-wrapper--prev'><div class='c-slider__icon-inner'>" + $.themeAssets.arrow_left + "</div></div>",
                nextText: "<div class='c-slider__icon-wrapper c-slider__icon-wrapper--next'><div class='c-slider__icon-inner'>" + $.themeAssets.arrow_right + "</div></div>",
                smoothHeight: true,
    ...
    theme.customSelectorArrow = (function(el) {
        ...
        $('select', $(scope)).each(function() {
            $(this).wrap('<div class="jumpstart-selector clearfix c-filter-container c-filter__select"></div>');
